 ...
 *
 * Auth = MyDHL Express API HTTP Basic with the credentials from DHL's
 * "approved for testing" onboarding email:
 *   Authorization: Basic base64(DHL_API_USERNAME:DHL_API_PASSWORD).
 *
 * NOTE: do NOT use DHL_API_Key/DHL_API_Secret here — those are for DHL's
 * gateway/OAuth APIs (Zapier-style), a different DHL product. MyDHL
 * Express (/rates, /shipments) rejects them with 401.
 */
