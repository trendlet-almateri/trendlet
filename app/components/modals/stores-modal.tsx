...
export function StoresModal({ onClose }: Props) {
  ...
  const content = (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-2 sm:p-4">
      ...
      <div className="relative flex h-[580px] max-h-[calc(100svh-2rem)] w-full max-w-[860px] overflow-hidden rounded-2xl border border-[var(--line)] bg-[var(--panel)] shadow-[var(--shadow-md)]" style={{ animation: "riseIn 0.2s cubic-bezier(0.16,1,0.3,1) forwards" }}>
