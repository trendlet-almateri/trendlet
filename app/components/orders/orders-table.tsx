      ...
      <table className="w-full border-collapse text-[13px]">
        <thead className="sticky top-0 z-10">
          <tr className="border-b border-[var(--line)] bg-[var(--hover)] text-[11px] font-semibold uppercase tracking-[0.14em] text-[var(--muted)] shadow-[0_1px_0_var(--line)]">
            ...
            <th className="whitespace-nowrap px-3 py-3 text-center font-semibold">Customer</th>
            <th className="hidden whitespace-nowrap px-3 py-3 text-center font-semibold md:table-cell">Sub-orders</th>
            <th className="min-w-[160px] whitespace-nowrap px-3 py-3 text-center font-semibold">Status</th>
            ...
            <th className="hidden w-[72px] whitespace-nowrap px-3 py-3 text-center font-semibold md:table-cell">Actions</th>
          </tr>
        </thead>
        <tbody>
          {orders.map((o) => (
